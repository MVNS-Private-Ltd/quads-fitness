...
export default function ExplodingWeightSection() {
  ...
  const o1 = getOpacity(0.00, 0.03, 0.13, 0.25);
  const o2 = getOpacity(0.13, 0.25, 0.43, 0.55);
  const o3 = getOpacity(0.43, 0.55, 0.73, 0.85);
  const o4 = getOpacity(0.73, 0.85, 1.00, 1.00);
