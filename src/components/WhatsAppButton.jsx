...
export default function WhatsAppButton() {
  ...
  const message = encodeURIComponent("Hi! I'm interested in joining Quads Fitness.");
  ...
  return (
    <AnimatePresence>
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-[5.5rem] right-6 z-40 bg-[#25D366] text-white p-4 rounded-full shadow-2xl shadow-[#25D366]/20 flex items-center justify-center group"
