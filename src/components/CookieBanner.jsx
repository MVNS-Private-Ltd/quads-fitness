      ...
      {isVisible && (
        ...
        >
          <div className="max-w-4xl mx-auto bg-brand-surface border border-white/10 p-6 shadow-2xl pointer-events-auto flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-white font-display uppercase tracking-wider mb-2">Cookie Preferences</h3>
              <p className="text-white/60 font-body text-sm leading-relaxed">
                We use cookies to optimize your experience, analyze site traffic, and personalize content. Accept to continue.
              </p>
            </div>
